...
@section('content')
    <form action="{{route('admin.news.update', $oneNews)}}" method="post" enctype="multipart/form-data">
        ...
        <input style="margin-top: 30px" type="text" id="author" name="author"
               value="{{old('author')?? $oneNews->author }}"
        ...
        <textarea onfocus="{{$oneNews->description}}" style="margin-top: 30px" type="text" id="description"
